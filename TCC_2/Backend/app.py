...
@app.route('/saude_mulher')
def saude_mulher():
    return render_template('saude_mulher.html')

@app.route('/tela_menopausa')
def tela_menopausa():
    return render_template('tela_menopausa.html')

@app.route('/tela_puberdade')
def tela_puberdade():
    return render_template('tela_puberdade.html')

@app.route('/tela_reprodutiva')
def tela_reprodutiva():
    return render_template('tela_reprodutiva.html')
